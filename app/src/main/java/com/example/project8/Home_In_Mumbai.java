...
public class Home_In_Mumbai extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home__in__mumbai);
        ...
        FirebaseRecyclerOptions<house> options
                ...
                .setQuery(FirebaseDatabase.getInstance().getReference().child("Houses/All_Houses").orderByChild("place").startAt("Mumbai").endAt("Mumbai"), house.class)
                .build();
